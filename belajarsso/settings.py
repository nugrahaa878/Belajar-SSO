"""
Django settings for belajarsso project.
...
SECRET_KEY = 'django-insecure-pnlsv_z(#n5_&ei&**b=jgn3rw(ung2=9!(^zrc4814ayak&_^'
...
WSGI_APPLICATION = 'belajarsso.wsgi.application'
